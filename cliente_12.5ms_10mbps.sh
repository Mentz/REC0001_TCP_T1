...
# DELAY 12.5, THROTTLE 10mbit, LOSS 0%
DL=12.5ms
THR=10mbit
LOSS=0
...
# DELAY 12.5, THROTTLE 10mbit, LOSS 0.001%
LOSS=0.001
tc qdisc del dev $INTERFACE root 
tc qdisc add dev $INTERFACE root netem delay $DL rate $THR loss $LOSS
iperf -c $SERVER_IP -t 120 -i 1 -p 50000 -e -Z reno >> "results/$DL-$THR-$LOSS-reno.txt"
...
# DELAY 12.5, THROTTLE 10mbit, LOSS 0.01%
LOSS=0.01
tc qdisc del dev $INTERFACE root 
tc qdisc add dev $INTERFACE root netem delay $DL rate $THR loss $LOSS
iperf -c $SERVER_IP -t 120 -i 1 -p 50000 -e -Z reno >> "results/$DL-$THR-$LOSS-reno.txt"
...
# DELAY 12.5, THROTTLE 10mbit, LOSS 0.1%
LOSS=0.1
tc qdisc del dev $INTERFACE root 
tc qdisc add dev $INTERFACE root netem delay $DL rate $THR loss $LOSS
iperf -c $SERVER_IP -t 120 -i 1 -p 50000 -e -Z reno >> "results/$DL-$THR-$LOSS-reno.txt"
...
# DELAY 12.5, THROTTLE 10mbit, LOSS 1.0%
LOSS=1
tc qdisc del dev $INTERFACE root 
tc qdisc add dev $INTERFACE root netem delay $DL rate $THR loss $LOSS
iperf -c $SERVER_IP -t 120 -i 1 -p 50000 -e -Z reno >> "results/$DL-$THR-$LOSS-reno.txt"
...
# DELAY 12.5, THROTTLE 10mbit, LOSS 10%
LOSS=10
tc qdisc del dev $INTERFACE root 
tc qdisc add dev $INTERFACE root netem delay $DL rate $THR loss $LOSS
iperf -c $SERVER_IP -t 120 -i 1 -p 50000 -e -Z reno >> "results/$DL-$THR-$LOSS-reno.txt"
